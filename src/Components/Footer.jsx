...
const Footer = () => {
  return (
    <div className='bg-[#fcf9fc] text-gray-500/80 pt-8 px-6 md:px-16 
    lg:px-24 xl:px-32'>
        <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
            <div className='max-w-80'>
                <img src={assets.logo} alt="logo" className='invert mb-4 
                h-8 md:h-9 opacity-80' />
            ...
            <div className='max-w-80'>
                ...
                <div className='flex items-center mt-4'>
                    ...
                    border border-gray-300 h-9 px-3 outline-none' 
        ...
        justify-between py-5'>
            <p>© {new Date().getFullYear()} Aswani V A. All rights reserved.</p>
