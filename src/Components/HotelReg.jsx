  ...
  return (
    ...
    justify-center bg-black/70'>
        ...
        <form className='flex bg-white rounded-xl max-w-4xl max-md:mx-2'>
            ...
            md:p-10'>
                <img onClick={() => setRegOpen(!regOpen)} src={assets.closeIcon} 
                alt="close-icon" className='absolute top-4 right-4 h-4 w-4 
                cursor-pointer'/>
                ...
                <div className='w-full mt-4 max-w-60 mr-auto'>
                    ...
                    <select name="" id="city" className='border border-gray-200
