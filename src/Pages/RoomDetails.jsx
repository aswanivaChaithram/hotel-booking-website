  ...
  return room && (
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
      ...
      <div className='flex flex-col lg:flex-row mt-6 gap-6'>
        ...
        <div className='grid grid-cols-2 gap-4 lg:w-1/2  w-full'>
          {room?.images.length > 1 && room.images.map((image, index) => (
            <img src={image} alt="room-image" key={index} onClick={() => 
              setMainImage(image)} className={`w-full rounded-xl shadow-md 
      ...
      p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
        ...
        <div className='flex flex-col gap-4 flex-wrap md:flex-row items-start
        md:items-center md:gap-10 text-gray-500'>
          ...
          <div className='flex flex-col'>
            ...
            className='w-full rounded border border-gray-300 py-2 mt-1.5 px-2
      ...
      text-gray-500'>
        <p>Guests will be allocated on the ground floor according to 
          ...
          for groups. The Guests will be allocated ground floor according
          to availability. You get the comfortable two bedroom apartment 
