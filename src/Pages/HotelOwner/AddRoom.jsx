  ...
  return (
    <div>
        <form>
            ...
            in the details carefully and accurate room details, pricing and 
            ...
            <div className='grid grid-cols-2 sm:flex gap-4 my-2 flex-wrap'>
                {Object.keys(images).map((key) => (
                    ...
                    <label htmlFor={`roomImage${key}`} key={key}>
                        <img className='max-h-16 cursor-pointer'
                         src={images[key] ? URL.createObjectURL(images[key]) : 
                            assets.uploadArea} alt="Preview" />

                        <input type="file" accept='image/*' id={`roomImage${key}`} 
                        hidden onChange={e => setImages({...images, [key] : 
                            e.target.files[0]
                        })} />
                    </label>
                ))}
            ...
            <div className='w-full flex max-sm:flex-col sm:gap-4 mt-4'>
                <div className='flex-1 max-w-48'>
                    ...
                    ({...inputs, roomType: e.target.value})}
                ...
                <div>
                    ...
                    border-gray-300 mt-1 rounded p-2 w-24' 
